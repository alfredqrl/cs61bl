...
public class MemoryGame {
    ...
    public String generateRandomString(int n) {
        ...
        for (int i = 0; i < n; i++){
            int a = RandomUtils.uniform(rand, CHARACTERS.length);
            rndStr.append(CHARACTERS[a]);
        }
    ...
    public void flashSequence(String letters) {
        ...
        for (int i = 0; i < letters.length(); i++){
            ...
            drawFrame(Character.toString(tempChar));
            StdDraw.pause(1000);
            drawFrame("");
            StdDraw.pause(500);
        }
    ...
    public String solicitNCharsInput(int n) {
        ...
        while (outputString.length() < n){
            ...
            // I want to show what I am just typing but not work
                drawFrame(outputString.toString());
                StdDraw.pause(500);
            }
        }
    ...
    public void startGame() {
        ...
        while (!gameOver) {
            ...
            if (playerTurn) {
                //drawFrame("Your turn: ");
                //StdDraw.pause(3000);
                String temp = this.solicitNCharsInput(this.round);
                if (temp.equals(randomString)) {
                    this.round++;
                } else {
                    this.gameOver = true;
                }
