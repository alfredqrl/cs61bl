...
public class SLList {
    ...
    public void add(int index, int x) {
        ...
        if (index > this.size()){
            ...
            curr.next = new IntListNode(x, sentinel);
            size++;
            return;
        }
    ...
    public void reverse() {
        ...
        IntListNode newInt = reverseHelper(sentinel.next);
        sentinel.next = newInt;
    }

    private IntListNode reverseHelper(IntListNode re){
        //if (re == null || )
        IntListNode temp;
        IntListNode temp2;
        if (re.next == sentinel){
            ...
            temp = reverseHelper(re.next);
            temp2 = temp;
            while (temp2 != sentinel){
                temp2 = temp2.next;
            }
            temp2.next = re;
            re.next = sentinel;
